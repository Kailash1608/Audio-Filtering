...
\begin{lstlisting}
$https:https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/Kailash-Singing.wav
\end{lstlisting}
\item 
\label{Python code}
...
\begin{figure}[H]
    \includegraphics[width=0.8\columnwidth]{Figs/Before_Filtering.png }
    \caption{Spectrogram of the audio file before Filtering}
    \label{fig:before_filter_plot}
\end{figure}
\begin{figure}[H]
\includegraphics[width=0.8\columnwidth]{Figs/After_Filtering.png}
...
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/2.2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/2.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/4.4.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/5.3.py
\end{lstlisting}
...
\begin{lstlisting}
  https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/5.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/6.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/6.2.py
\end{lstlisting}
\input{Tables/audio_filter_tab.tex}
...
\begin{lstlisting}
hhttps://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/6.2_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{Figs/6.2_Filter_Response.png}
...
\end{align}
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/6.2_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{Figs/6.2_Butterworth_analog.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{Figs/6.2.Pole_Zero_Plt.png}
...
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/fft.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/6.3_fft.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/6.4.c
\end{lstlisting}
The below python code extracts the data from these text files and plots Time vs $n$ for comparison.
\begin{lstlisting}
https://github.com/Kailash1608/Audio-Filtering/blob/main/Audio_Filtering/Codes/6.4.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{Figs/6.4.png}
